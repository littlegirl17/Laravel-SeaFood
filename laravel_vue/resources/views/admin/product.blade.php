                        ...
                        <div class="form-group mt-3">
                            ...
                            <select class="form-select  rounded-0" aria-label="Default select example" name="filter_iddm">
                                ...
                                @foreach ($categorys as $item)
                                    <option
                                        value="{{ $item->id }}"{{ !empty($filter_iddm) ? ($filter_iddm == $item->id ? 'selected' : '') : '' }}>
                                        {{ $item->name }}
                                    </option>
                                @endforeach
                            </select>
        ...
        <form id="submitFormAdmin">
            ...
            <div class="buttonProductForm mt-3">
                ...
                <button class="btn btnF3" type="button"
                    onclick="submitForm('{{ route('product.checkboxCopy') }}','post')"><i class="pe-2 fa-solid fa-copy"
                        style="color: #ffffff;"></i>Copy sản phẩm</button>
                <button class="btn btnF2" type="button"
                    onclick="submitForm('{{ route('product.checkboxDelete') }}','post')"><i class="pe-2 fa-solid fa-trash"
                                ...
                                <td class="m-0 p-0">
                                    <div class="actionAdminProduct m-0 py-3">
                                        <button class="btnActionProductAdmin1"><a
                                                href="{{ url('detail-product', $item['slug']) }}"
                                        ...
                                        <button class="btnActionProductAdmin2"><a
                                                href="{{ route('productEdit', $item['id']) }}"
