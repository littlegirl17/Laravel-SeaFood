                    ...
                    <div class="col-sm-6">
                        <div class="form-group mt-3">
                            ...
                            <input class="form-control rounded-0" name="filter_name" placeholder="Tên danh mục"
                                type="text" value="{{ !empty($filter_name) ? $filter_name : '' }}">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group mt-3">
        ...
        <form id="submitFormAdmin">
            ...
            <div class="buttonProductForm mt-3">
                ...
                <button class="btn btnF2" type="button"
                    onclick="submitForm('{{ route('category.checkboxDelete') }}','post')">
                    ...
                    <tbody class="table-body">
                        @foreach ($categorys as $item)
                            <tr class="">
                                ...
                                <td class=""><img src="{{ asset('uploads/' . $item->image) }}"
                                ...
                                <td class="">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            ...
                                            {{ $item->status == 1 ? 'checked' : '' }} style="font-size:20px; ">
                                ...
                                <td class="">
                                    <div class="actionAdminProduct m-0 py-3">
                                        <button class="btnActionProductAdmin2"><a
                                                href="{{ route('categoryEdit', $item['id']) }}"
