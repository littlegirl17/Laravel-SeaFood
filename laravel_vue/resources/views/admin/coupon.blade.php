                    ...
                    <div class="col-sm-3">
                        <div class="form-group mt-3">
                            ...
                            <input class="form-control rounded-0" name="filter_total" placeholder="Tổng số tiền giảm"
                                type="number" value="{{ $filter_total ?? '' }}">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group mt-3">
        ...
        <form id="submitFormAdmin">
            ...
            <div class="buttonProductForm mt-3">
                <button class="btn btnF1">
                    <a href="{{ route('admin.couponAdd') }}" class="text-decoration-none text-light"><i
                        ...
                        @foreach ($coupons as $item)
                            <tr class="">
                                <td class="text-center" style="width:20px">
                                    <input class="" type="checkbox" name="coupon_id[]" value="{{ $item->id }}">
                                ...
                                <td class="m-0 p-0">
                                    <div class="actionAdminProduct m-0 py-3">
                                        <button class="btnActionProductAdmin2"><a
                                                href="{{ route('admin.couponEdit', $item['id']) }}"
