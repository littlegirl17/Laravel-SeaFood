                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="province"
                                    ...
                                    @if ($administration->province)
                                        <option selected value="{{ $administration->province }}">
                                            {{ $administration->province }}</option>
                                    @else
                            ...
                            <div class="form-group mt-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="district"
                                    id="district">
                                    @if ($administration->district)
                                        <option selected value="{{ $administration->district }}">
                                            {{ $administration->district }}</option>
                                    @else
                            ...
                            <div class="form-group mt-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="ward"
                                    id="ward">
                                    @if ($administration->ward)
                                        <option selected value="{{ $administration->ward }}">{{ $administration->ward }}
                                        </option>
                                    @else
                                ...
                                <select class="form-select " name="user_group_id">
                                    @foreach ($administrationGroups as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $item->id == $administration->user_group_id ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
