                        ...
                        @foreach ($cart as $item)
                            @if (is_array($item))
                                @php
                                    ...
                                    $SoTien = $product ? $product->price : 0;
                                ...
                                <tr class=" itemcart">
                                    <td class="">
                                        <div class="imgName">
                                            <img src="uploads/{{ $product->image }}" class="imgCart" alt="">
                                            <h6 class="ps-3">{{ $product->name }}</h6>
                                        </div>
                                    </td>
                                    <td class="">
                                    ...
                                    <td class="">
                                        <span><a href="{{ route('deleteItem', $item['product_id']) }}"
                            ...
                            <tr class=" itemcart">
                                ...
                                <td class="">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="input-number border" name="quantity"
                                            value="{{ $item['quantity'] }}" min="1" max="10">
                                        <span class="input-group-btn">
                                            <a href="{{ route('tang', $product->id) }}"
                                                class="text-decoration-none "><button type="button"
