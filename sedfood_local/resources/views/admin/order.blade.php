        ...
        @if (!$isSearching)
            <div class="row">
                <div class="col-sm-12 btnOrderAdmin">
                    <a href="{{ route('admin.order', ['status_id' => 'all']) }}" class="btn btn-success rounded-0"
                        style="background-color: #F38773">Tất cả</a>
                    <a href="{{ route('admin.order', ['status_id' => 1]) }}" class="btn btn-success rounded-0"
                        style="background-color: #1A16B5">Mới ({{ $countNew }})</a>
                    <a href="{{ route('admin.order', ['status_id' => 2]) }}" class="btn btn-success rounded-0"
                        style="background-color: #E8BE21">Đang xử lý ({{ $countProcessing }})</a>
                    <a href="{{ route('admin.order', ['status_id' => 3]) }}" class="btn btn-success rounded-0"
                        style="background-color: #188DD1">Đã giao hàng ({{ $countShipped }})</a>
                    <a href="{{ route('admin.order', ['status_id' => 4]) }}" class="btn btn-success rounded-0"
                        style="background-color: #07884B">Hoàn thành ({{ $countCompleted }})</a>
                    <a href="{{ route('admin.order', ['status_id' => 5]) }}" class="btn btn-success rounded-0"
